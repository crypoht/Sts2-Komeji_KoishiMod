...
namespace KomeijiKoishi.Cards.Danmaku
{
    ...
    public sealed class RiceDanmaku_Koishi : CustomCardModel
    {
        ...
        protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
        {
            ...
            DanmakuProjectileHelper.AddToCombat(base.Owner.Creature, cardPlay.Target, "rice");
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                CardPileAddResult cardPileAddResult = await CardPileCmd.AddGeneratedCardToCombat(cardModel, PileType.Exhaust, base.Owner, CardPilePosition.Bottom);
